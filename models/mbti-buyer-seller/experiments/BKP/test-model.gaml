...
global {
	...
	file map_init <- image_file("raster_map.png");
...
species prey parent: generic_species {
	...
	image_file my_icon <- image_file("sheep.png");
...
species predator parent: generic_species {
	...
	image_file my_icon <- image_file("wolf.png");
...
experiment Optimization type: batch repeat: 2 keep_seed: true until: ( time < 3 ) {
	...
	method sobol outputs:["nb_preys"] sample: 100 report:"C:/Users/lubraz/OneDrive/Master Degree/Workspace/Gama/MBTI/models/mbti-buyer-seller/experiments/sobol.txt" results:"C:/Users/lubraz/OneDrive/Master Degree/Workspace/Gama/MBTI/models/mbti-buyer-seller/experiments/sobol_raw.csv";
	...
	reflex save_results_explo {
		ask simulations {
			save [int(self),prey_max_transfer,prey_energy_reproduce,predator_energy_transfer,predator_energy_reproduce,self.nb_predators,self.nb_preys] 
		   		to: "results01.csv" type: "csv" rewrite: (int(self) = 0) ? true : false header: true;
		}		
	}
}