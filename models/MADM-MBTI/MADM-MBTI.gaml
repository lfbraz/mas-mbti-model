...
experiment MBTI_Low type: gui benchmark: false  {
	...
	// parameter "Teams Personality" category:"Team" var: teams_personality <- "heterogeneous" among: ["heterogeneous", "homogeneous"];
	...
	user_command "I+random" {create sellers number: nbsellers {
							 do init(['I','R','R','R']);
							 }}
